...
def test_send_p2sh_explicit_to_confidential_sign(client):
    ...
    with client:
        client.set_expected_responses(list(signature_responses(txins, txouts)))
        _, serialized_tx = btc.sign_tx(
            client,
            "Elements",
            txins,
...
def test_send_elements_multisig_csv_1_confidential(client):
    ...
    # blinded signed transaction (without range/surjection proofs)
    assert (
        serialized_tx.hex()
        == ""
    )
...
def test_send_elements_multisig_csv_2_confidential(client):
    ...
    assert (
        serialized_tx.hex()
        == ""
    )
...
def signature_responses(txins, txouts):
    txin_requests = [
        proto.TxRequest(
            request_type=proto.RequestType.TXINPUT,
    ...
    yield from txin_requests
    for txout_request in txout_requests:
        yield txout_request
        yield proto.ButtonRequest(code=proto.ButtonRequestType.ConfirmOutput)

    yield proto.ButtonRequest(code=proto.ButtonRequestType.SignTx)
    yield from txin_requests
    yield from txout_requests
    yield from txin_requests
    yield proto.TxRequest(request_type=proto.RequestType.TXFINISHED)

"""
Source: https://github.com/Simplexum/python-bitcointx/blob/confidential_transactions/bitcointx/core/secp256k1.py
"""
...
_path = os.path.join(
    _cwd, "../../../../core/vendor/secp256k1-zkp/.libs/libsecp256k1.so"
)
secp256k1 = ctypes.cdll.LoadLibrary(_path)
...
def _set_zkp_func_types():
    ...
    secp256k1.secp256k1_generator_parse.argtypes = [
        ctypes.c_void_p,
        ctypes.c_char_p,
        ctypes.c_char_p,
    ]
    secp256k1.secp256k1_generator_generate.restype = ctypes.c_int
    secp256k1.secp256k1_generator_generate.argtypes = [
        ctypes.c_void_p,
        ctypes.c_char_p,
        ctypes.c_char_p,
    ]
...
secp256k1.secp256k1_context_set_illegal_callback.argtypes = [
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.c_void_p,
]
...
secp256k1.secp256k1_context_set_error_callback.argtypes = [
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.c_void_p,
]
...
secp256k1.secp256k1_ec_pubkey_tweak_add.argtypes = [
    ctypes.c_void_p,
    ctypes.c_char_p,
    ctypes.c_char_p,
]
...
secp256k1.secp256k1_ec_privkey_tweak_add.argtypes = [
    ctypes.c_void_p,
    ctypes.c_char_p,
    ctypes.c_char_p,
]
...
def _set_error_callback(ctx):
    ...
    secp256k1.secp256k1_context_set_illegal_callback(

...
class TestMsgLiquidFixed(TrezorTest):
    ...
    # TODO: make sure blinding key is not the public key...
    ...
    def test_get_blinded_address_pkh(self):
        ...
        assert (
            addr
            == "CTEtR7jUhyTLXNbux1oAJsFe3QAD2QV6i6RVstekQLmd6p8NdNnfz4j7gP4DCJEQctkecex9SPaAY2XG"
        )
    ...
    def test_get_blinded_address_p2sh(self):
        ...
        assert (
            addr
            == "Azpoy5k615yvxRA39MY4k5seT2Sbdjv4k9pDwducFBQmKKY2t1wJ7DzhY1Kek17h9ZJyi1LVA8p47rRZ"
        )

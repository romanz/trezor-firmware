...
class TestMsgLiquidFixed(TrezorTest):
    ...
    BLIND_OUTPUTS = [
        LiquidBlindOutput(
            ...
            committed_script=bytes.fromhex('76a914f24bb0c13089fb711ecf5c133e7df0818e1b1a5988ac'),
        ...
        LiquidBlindOutput(
            ...
            committed_script=bytes.fromhex('76a914248036444a09a71e10ff91c8034ba213a179af9d88ac'),
    ...
    def test_blind(self):
        ...
        for i, blinded_output in enumerate(blinded):
            _verify_range_proof(blinded_output,
                                self.BLIND_OUTPUTS[i].committed_script)
...
def _verify_range_proof(blinded_output, extra_commit):
